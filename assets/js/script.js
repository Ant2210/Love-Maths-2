...
//Get buton elements and add event listeners to them
...
/**
 * Get operands (numbers) and the operator (plus, minus etc.)
...
function displayDivideQuestion(operand1, operand2) {
    ...
    while (operand1 < operand2 || operand1 % operand2 !== 0 || operand1 / operand2 === 1) {
        operand1 += 1;
    }
